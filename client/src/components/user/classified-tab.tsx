...
import { getUsersClassifiedListings } from "@/api";
            ...
            {classifiedListings.length === 0 ? (
              ...
              classifiedListings.map((listing: any) => (
                <motion.div
                  ...
                  className="cursor-pointer p-4 md:p-6 border border-gray-200 rounded-lg hover:shadow-md transition-all duration-200 bg-white"
                    ...
                    <div className="flex-1 space-y-3  w-full">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                        <div className="flex flex-col text-gray-600">
                          <span className="truncate">{listing.make}</span>
                      ...
                      {listing.description && (
                        <p className="text-gray-700 text-sm max-w-full truncate ">
                          {listing.description &&
