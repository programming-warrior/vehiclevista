  ...
  return (
    <>
      <Card className="border-gray-200">
        <CardHeader>
          <CardTitle className="text-black">Saved Vehicles</CardTitle>
          <CardDescription className="text-gray-600">
            Vehicles you've added to Favourites
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            >
              {favouriteVehicles.length === 0 ? (
                <Alert className="bg-blue-50 text-blue-800 border-blue-200">
                  ...
                  <AlertTitle>You haven't saved any vehicle</AlertTitle>
                  <AlertDescription></AlertDescription>
                </Alert>
              ) : (
                favouriteVehicles.map((listing: any) => (
                  <motion.div
                    key={listing.id}
                    variants={{
                          ...
                          <DropdownMenuItem
                            onClick={(e) => {
                              ...
                              addOrRemoveVehicleToFavouriteApi(
                                ...
                                console.error("failed to remove from favourite")
                              );
                              removeVehicleFromFavourite(listing.id);
                            }}
        ...
        <CardFooter className="pt-2 flex flex-col sm:flex-row sm:justify-between gap-2 bg-blue-50">
          <div className="text-sm text-blue-600 order-2 sm:order-1">
            Showing {favouriteVehicles.length} of {favouriteVehicles.length} listings
          </div>
          {totalPages > 1 && (
...
export default ProfileFavouriteVehicleTab;
